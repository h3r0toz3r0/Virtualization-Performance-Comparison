...
echo "norm_resid,resid,machep,x1,xN,factor,solve,total,mflops,unit,cray" > results_linpack_native.csv
num=10                 
for i in $( seq 1 $num )      
do
    echo "  ... iteration: $i"
	...
	echo "$a,$b,$c,$d,$e,$f,$g,$h,$i,$j,$k" >> results_linpack_native.csv
